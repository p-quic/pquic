...
static __attribute__((always_inline)) void tinymt32_init(tinymt32_t * random, uint32_t seed);
static __attribute__((always_inline)) void tinymt32_init_by_array(tinymt32_t * random, uint32_t init_key[],
                            int key_length);
 ...
 */
__attribute__((always_inline)) static uint32_t tinymt32_temper(tinymt32_t * random) {
    uint32_t t0, t1;
    t0 = random->status[3];
 ...
 */
__attribute__((always_inline)) static uint32_t tinymt32_generate_uint32(tinymt32_t * random) {
 ...
 */
static __attribute__((always_inline)) uint32_t ini_func1(uint32_t x) {
 ...
 * @return 32-bit integer
 */
static __attribute__((always_inline)) uint32_t ini_func2(uint32_t x) {
