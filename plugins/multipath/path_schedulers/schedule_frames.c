...
protoop_arg_t schedule_frames(picoquic_cnx_t *cnx) {
    ...
    picoquic_path_t *path_x = schedule_path(cnx, retransmit_p, from_path, reason, bpfdd->requires_duplication);
    PUSH_LOG_CTX(cnx, "\"path\": \"%p\"", (protoop_arg_t) path_x);
