...
static __attribute__((always_inline)) picoquic_path_t *schedule_path_rr(picoquic_cnx_t *cnx, picoquic_packet_t *retransmit_p, picoquic_path_t *from_path, char* reason) {
...
protoop_arg_t schedule_frames_on_path(picoquic_cnx_t *cnx)
{
    ...
    picoquic_path_t *path_x = schedule_path_rr(cnx, retransmit_p, from_path, reason);
